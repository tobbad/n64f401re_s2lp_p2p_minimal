...
/* USE_S2868A2_RADIO_GPIO_x is set if the relevant GPIO_x is used for
 * any purpose (Input, Output or EXTI).
 * The actual MODE will be reflected in the s2868a2_conf.h file in
 * S2868A2_RADIO_GPIO_x_MODE macros that assume these possible values:
 *
 * typedef enum
 * {
 ...
 *
 * like defined in s2868a2.h file.
...
#define USE_S2868A2_RADIO_GPIO_0                        0
#define USE_S2868A2_RADIO_GPIO_1                        0
#define USE_S2868A2_RADIO_GPIO_2                        0
#define USE_S2868A2_RADIO_GPIO_3                        1

/* GPIO Mode: Above macros define if a GPIO is used in any mode,
 * the specific MODE in defined the s2868a2_conf.h file
 */

/* S2868A2_RADIO_GPIO define the "main" radio GPIO that must always
...
*/
#define S2868A2_RADIO_GPIO                              S2868A2_RADIO_GPIO_3
