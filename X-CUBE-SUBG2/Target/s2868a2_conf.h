...
/* S2868A2_RADIO_GPIO_0 is NOT set as EXTI */
...
/* S2868A2_RADIO_GPIO_3 is set as EXTI */
#define S2LP_NVIC_GPIO_3_DisableIRQ()	HAL_NVIC_DisableIRQ( S2868A2_RADIO_GPIO_3_IRQn)
#define S2LP_NVIC_GPIO_3_EnableIRQ()	HAL_NVIC_EnableIRQ( S2868A2_RADIO_GPIO_3_IRQn)
...
#define S2868A2_RADIO_SPI_NSS_CLK_ENABLE()                  __HAL_RCC_GPIOA_CLK_ENABLE()
#define S2868A2_RADIO_SPI_NSS_PORT                          GPIOA
#define S2868A2_RADIO_SPI_NSS_PIN                           GPIO_PIN_1
...
/* GPIO3 as EXTI */
#define S2868A2_RADIO_GPIO_3_PORT                            GPIOC
#define S2868A2_RADIO_GPIO_3_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOC_CLK_ENABLE()
#define S2868A2_RADIO_GPIO_3_PIN                             GPIO_PIN_0
#define S2868A2_RADIO_GPIO_3_EXTI_LINE                       EXTI_LINE_0
#define S2868A2_RADIO_GPIO_3_IRQn                            EXTI0_IRQn
#define H_EXTI_0                                             S2868A2_RADIO_GPIO_hexti[0]
#define S2868A2_RADIO_GPIO_3_MODE                            RADIO_MODE_EXTI_IN
#define S2868A2_RADIO_GPIO_3_EXTI_MODE                       GPIO_MODE_IT_FALLING
#define S2868A2_RADIO_GPIO_3_IT_PRIO                         0
#define S2868A2_RADIO_GPIO_3_IT_SUBPRIO                      0
#define S2868A2_RADIO_GPIO_3_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for EXTI mode */
#define S2868A2_RADIO_GPIO_3_PULL_MODE                       GPIO_NOPULL
...
#define S2868A2_RADIO_GPIO_SDN_PIN                           GPIO_PIN_8
#define S2868A2_RADIO_GPIO_SDN_SPEED                         GPIO_SPEED_FREQ_HIGH
#define S2868A2_RADIO_GPIO_SDN_PULL_MODE                     GPIO_NOPULL

#define S2868A2_LEDn                                        (1)
#define S2868A2_LED_GPIO_PORT                               GPIOC
#define S2868A2_LED_GPIO_PIN                                GPIO_PIN_7
#define S2868A2_LED_GPIO_SPEED                              GPIO_SPEED_FREQ_HIGH
#define S2868A2_LED_GPIO_PULL_MODE                          GPIO_PULLUP
#define S2868A2_LED_GPIO_CLK_ENABLE()                       __HAL_RCC_GPIOC_CLK_ENABLE()              /*Rx Indicator LED, FOR LED Mount R17*/
