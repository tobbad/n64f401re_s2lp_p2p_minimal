...
#define radio_gpio_0_Pin GPIO_PIN_0
#define radio_gpio_0_GPIO_Port GPIOA
...
#define radio_gpio_1_GPIO_Port GPIOA
#define radio_gpio_2_Pin GPIO_PIN_0
#define radio_gpio_2_GPIO_Port GPIOB
